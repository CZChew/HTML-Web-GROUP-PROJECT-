      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/shirt1-front.jpg" id="men" name="menshirt" alt="Men's Red Round Neck T-Shirt">
            <img src="css/images/shirt1-back.jpg" id="men" name="menshirt" alt="Men's Red Round Neck T-Shirt">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Men's Red Round Neck T-Shirt</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Men's Red Round Neck T-Shirt">
              <input type="hidden" name="prodPrice" value="34.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/shirt1-front.jpg' alt='item7'>">
              <br>
              <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >Sometimes, all you need is a simple T-shirt that will keep you conmfortable, but still ensure you look good at the same time. With this T-shirt, your comfort is ensured no matter where you are and its bright red colour will surely make you stand out.</p>
            <ul>
              <li>100% cotton</li>
