      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/shorts2-front.png" id="men-shorts" name="menshorts" alt="Men's Camo Sweat Shorts">
            <img src="css/images/shorts2-back.png" id="men-shorts" name="menshorts" alt="Men's Camo Sweat Shorts">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Men's Camo Sweat Shorts</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Men's Camo Sweat Shorts">
              <input type="hidden" name="prodPrice" value="24.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/shorts2-front.png' alt='item12'>">
              <br>
              <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >This pair of sweat shorts will provide endless comfort, all while providing you with a stylish camo design </p>
            <ul>
              <li>100% cotton</li>
