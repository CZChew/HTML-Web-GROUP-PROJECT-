      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/shorts3-front.png" id="men-shorts" name="menshorts" alt="Men's Black Sweat Shorts">
            <img src="css/images/shorts3-back.png" id="men-shorts" name="menshorts" alt="Men's Black Sweat Shorts">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Men's Black Sweat Shorts</h2> <hr id="product-line">
            <p class="prodPrice" >Price: RM 24.99</p>
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Men's Black Sweat Shorts">
              <input type="hidden" name="prodPrice" value="24.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/shorts3-front.jpg' alt='item13'>">
              <br>
                <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >This pair of sweat shorts will provide endless comfort for you while at the same time, be a versatile addition to your wardrobe which will go well with just about anything.</p>
            <ul>
              <li>100% cotton</li>
              <li>Two side pocket</li>
              <li>One back pocket</li>
              <li>Ironed-on "Ulti-Dry" logo</li>
