      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/sweater1-front.jpg" id="men-sweater" name="mensweater" alt="Men's Glitchpop Sweater">
            <img src="css/images/sweater1-back.jpg" id="men-sweater" name="mensweater" alt="Men's Glitchpop Sweater">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Men's Black Glitchpop Sweater</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Men's Black Glitchpop Sweater">
              <input type="hidden" name="prodPrice" value="59.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/sweater1-front.jpg' alt='item5'>">
              <br>
              <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >This minimalist sweater will go well with just about any outfit you have in your wardrobe. The glitchy text effect on the front of the sweater gives the sweater a retro look that is in the trend among youths now.</p>
            <ul>
              <li>80% cotton</li>
              <li>Ironed-on "Ulti-Dry" Gltich Text</li>
              <li>Arm Pocket</li>
            </ul>
          </div>
        </div>
