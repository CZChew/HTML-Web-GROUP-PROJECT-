      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/shirt2-front.jpg" id="men" name="menshirt" alt="Men's White Round Neck T-Shirt">
            <img src="css/images/shirt2-back.jpeg" id="men" name="menshirt" alt="Men's White Round Neck T-Shirt">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Men's White Round Neck T-Shirt</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Men's White Round Neck T-Shirt">
              <input type="hidden" name="prodPrice" value="34.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/shirt2-front.jpg' alt='item8'>">
              <br>
              <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >Sometimes, all you need is a simple T-shirt that will keep you conmfortable, but still ensure you look good at the same time. This white round-neck will be a versatile addition to your wardrobe as it goes well with just about any outerwear or pants!</p>
            <ul>
              <li>100% cotton</li>
