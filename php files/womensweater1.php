      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/sweater2-front.jpg" id="women-sweater" name="womensweater" alt="Women's Pastel Sweater">
            <img src="css/images/sweater2-back.jpeg" id="women-sweater" name="womensweater" alt="Women's Pastel Sweater">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Women's Water Resistant Pastel Sweater</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Women's Water Resistant Pastel Sweater">
              <input type="hidden" name="prodPrice" value="64.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/sweater2-front.jpg' alt='item17'>">
              <br>
                <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >This sweater is for you to look good in whether it is raining or shining outside. The pastel green colour of the sweater will definitely be a cute addition to your wardrobe</p>
            <ul>
              <li>100% cotton</li>
