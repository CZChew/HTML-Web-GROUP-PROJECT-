      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/hoodie9-front.jpg" id="women-zip-hoodie" name="womenziphoodie" alt="Women's Oversized Hoodie">
            <img src="css/images/hoodie9-back.jpg" id="women-zip-hoodie" name="womenziphoodie" alt="Women's Oversized Hoodie">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Women's Black Oversized Hoodie</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodID" value="16">
              <input type="hidden" name="prodName" value="Women's Black Oversized Hoodie">
              <input type="hidden" name="prodPrice" value="64.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/hoodie9-front.jpg' alt='item16'>">
              <br>
                <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >This black oversized hoodie screams comfort in every way. Whether you are walking around in a mall or sitting in class at university, you can always rely on this hoodie for warmth and comfort at all times</p>
            <ul>
              <li>100% cotton</li>
