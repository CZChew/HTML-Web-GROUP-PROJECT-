      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/hoodie1-model.jpg" id="men-zip-hoodie" name="menziphoodie" alt="Men's Oriental Hoodie">
            <img src="css/images/hoodie1-front.jpg" id="men-zip-hoodie" name="menziphoodie" alt="Men's Oriental Hoodie">
            <img src="css/images/hoodie1-back.jpg" id="men-zip-hoodie" name="menziphoodie" alt="Men's Oriental Hoodie">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Men's Oriental-Design Black Hoodie</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Men's Oriental-Design Black Hoodie">
              <input type="hidden" name="prodPrice" value="69.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/hoodie1-front.jpg' alt='item1'>">
              <br>
