      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/shirt4-front.jpg" id="men" name="menshirt" alt="Men's White Long-Sleeve Polo">
            <img src="css/images/shirt4-back.jpg" id="men" name="menshirt" alt="Men's White Long-Sleeve Polo">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Men's White Long-Sleeve Polo</h2> <hr id="product-line">
            <p class="prodPrice" >Price: RM 44.99</p>
            <form class="addToCart" action="cart.php" method="post">
              <select class="size-select" name="size">
                <option>-- Select Size --</option>34
              ...
              <input type="hidden" name="prodName" value="Men's White Long-Sleeve Polo">
              <input type="hidden" name="prodPrice" value="44.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/shirt4-front.jpg' alt='item11'>">
              <br>
