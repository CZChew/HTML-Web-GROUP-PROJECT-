      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/shorts1-front.png" id="men-shorts" name="menshorts" alt="Men's Grey Sweat Shorts">
            <img src="css/images/shorts1-back.png" id="men-shorts" name="menshorts" alt="Men's Grey Sweat Shorts">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Men's Grey Sweat Shorts</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Men's Grey Sweat Shorts">
              <input type="hidden" name="prodPrice" value="24.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/shorts1-front.jpg' alt='item6'>">
              <br>
