      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/shirt3-front.jpg" id="men" name="menshirt" alt="Men's Black Glitchpop T-Shirt">
            <img src="css/images/shirt3-back.jpeg" id="men" name="menshirt" alt="Men's Black Glitchpop T-Shirt">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Men's Black Glitchpop T-Shirt</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Men's Black Glitchpop T-Shirt">
              <input type="hidden" name="prodPrice" value="34.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/shirt3-front.jpg' alt='item9'>">
              <br>
              <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >This T-Shirt is part of our Glitchpop line of products and is one you definitely don't want to miss out on. The simplicity and mininalistic design of the T-shirt will make it one you want to wear all the time.</p>
            <ul>
              <li>100% cotton</li>
              <li>Ulti-Dry Glitchpop Text Print</li>
            </ul>
          </div>
        </div>
      </div>
