      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/hoodie2-model.jpg" id="men-zip-hoodie" name="menziphoodie" alt="Men's Reflective Hoodie">
            <img src="css/images/hoodie2-front.jpg" id="men-zip-hoodie" name="menziphoodie" alt="Men's Reflective Hoodie">
            <img src="css/images/hoodie2-back.jpg" id="men-zip-hoodie" name="menziphoodie" alt="Men's Reflective Hoodie">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Men's White/Rose Gold Reflective Hoodie</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Men's White/Rose Gold Reflective Hoodie">
              <input type="hidden" name="prodPrice" value="64.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/hoodie2-front.jpg' alt='item2'>">
              <br>
              <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >This full zip hoodie is one you can wear in style whether it is raining or shining outside.The rose gold reflective accents on the hoodie will surely make you stand out of the crowd.</p>
            <ul>
              <li>High-Grade Nylon</li>
              <li>Adjustable Hoodie String</li>
