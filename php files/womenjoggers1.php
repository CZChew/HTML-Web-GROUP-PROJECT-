      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/joggers1-front.jpg" id="women" name="womenskirt" alt="Women's Black Joggers">
            <img src="css/images/joggers1-back.jpg" id="women" name="womenskirt" alt="Women's Black Joggers">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Women's Black Joggers</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Women's Black Joggers">
              <input type="hidden" name="prodPrice" value="34.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/joggers1-front.jpg' alt='item20'>">
              <br>
                <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >This pair of joggers is the ultimate comfort wear for you to use in every occasion. This is a prime example that comfort should never come at the cost of style.</p>
            <ul>
              <li>100% cotton</li>
