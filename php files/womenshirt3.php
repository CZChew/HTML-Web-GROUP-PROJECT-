      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/shirt8-front.jpg" id="women" name="womenshirt" alt="Women's Black Polo Shirt">
            <img src="css/images/shirt8-back.jpeg" id="women" name="womenshirt" alt="Women's Black Polo Shirt">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Women's Black Polo Shirt</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodID" value="25">
              <input type="hidden" name="prodName" value="Women's Black Polo Shirt">
              <input type="hidden" name="prodPrice" value="39.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/shirt8-front.jpg' alt='item25'>">
              <br>
                <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >This polo shirt is perfect for you in most occasions, whether it be a casual meetup with friends, or even a more formal setting with colleagues.</p>
            <ul>
              <li>70% polyester</li>
              <li>Sewed-on Ulti-Dry text</li>
            </ul>
          </div>
        </div>
      </div>
