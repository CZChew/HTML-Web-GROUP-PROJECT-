      ...
      <div class="product-container">
        <div class="product-image-container">
          <div class="product-preview">
            <img src="css/images/skirt1-front.jpg" id="women" name="womenskirt" alt="Women's Black Nylon Skirt">
            <img src="css/images/skirt1-back.jpg" id="women" name="womenskirt" alt="Women's Black Nylon Skirt">
          </div>
        </div>
        <div class="product-pricing-container">
          <div class="product-pricing">
            <h2 class="product-banner">Women's Black Nylon Skirt</h2> <hr id="product-line">
            ...
            <form class="addToCart" action="cart.php" method="post">
              ...
              <input type="hidden" name="prodName" value="Women's Black Nylon Skirt">
              <input type="hidden" name="prodPrice" value="39.99">
              <input type="hidden" name="memberNUM" value="<?php echo ".$profileID.";?>">
              <input type="hidden" name="prodImg" value="<img class='cart-item' src='css/images/skirt1-front.jpg' alt='item18'>">
              <br>
                <button id="addCart-button" type="submit" name="addCart">ADD TO CART</button>
            </form>
          </div>
          <div class="product-information">
            <p class="prodInformation" >This versatile and comfortable skirt will prove to be a valuable addition to your wardrobe as it goes well with just about anything. Plus, this skirt comes with practical pockets for your convenience!</p>
            <ul>
              <li>100% nylon</li>
              <li>Adjustable waist strap</li>
              <li>Two side deep pockets</li>
